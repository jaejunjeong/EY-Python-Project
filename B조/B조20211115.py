...
class MyApp(QWidget):
    ...
    def init_UI(self):
        ...
        self.splitter_layout.addWidget(self.Scenario_Select_Group())
    ...
    def Scenario_Select_Group(self):
        groupbox = QGroupBox('')
        label1 = QLabel('Scenario Group: ', self)
        font1 = label1.font()
        font1.setBold(True)
        label1.setStyleSheet("color: white;")

        self.Scenario_Cb = QComboBox(self)
        self.Scenario_Cb.activated[str].connect(self.Scenario_ComboBox_Selected)
        ...
        grid.addWidget(self.Scenario_Cb, 0, 1)
        grid.addWidget(btn1, 0, 2)
        groupbox.setLayout(grid)

        return groupbox

    def Scenario_ComboBox_Selected(self, text):
        print(text)
    ...
    def extButtonClicked9(self):
        ...
        if tempN == '' or tempTE == '':
            ...
            self.Scenario_Cb.addItem(str(result[1]))
            self.viewtable.setModel(model)
